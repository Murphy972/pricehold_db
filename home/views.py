...
def by_ph(request):
    orders = Order.objects.filter(order_isreserved=False)
    order_date = orders.order_by('order_date')
    ph_orders = order_date.filter(order_type='1')
...
def by_layaway(request):
    orders = Order.objects.filter(order_isreserved=False)
    pickup_date = orders.order_by('pickup_date')
    layaway_orders = pickup_date.filter(order_type='2')
...
def truck_serta(request):
    orders = Order.objects.filter(order_isreserved=False)
    order_date = orders.order_by('order_date')
    truck_serta = order_date.filter(truck='3')
...
def truck_sealy(request):
    orders = Order.objects.filter(order_isreserved=False)
    order_date = orders.order_by('order_date')
    truck_sealy = order_date.filter(truck='4')
...
def truck_united(request):
    orders = Order.objects.filter(order_isreserved=False)
    order_date = orders.order_by('order_date')
    truck_united = order_date.filter(truck='1')
...
def truck_ashley(request):
    orders = Order.objects.filter(order_isreserved=False)
    order_date = orders.order_by('order_date')
    truck_ashley = order_date.filter(truck='2')
...
def truck_freight(request):
    orders = Order.objects.filter(order_isreserved=False)
    order_date = orders.order_by('order_date')
    truck_freight = order_date.filter(truck='5')
